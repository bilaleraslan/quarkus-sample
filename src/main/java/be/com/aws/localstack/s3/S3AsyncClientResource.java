...
//        }
        ...
        return Uni.createFrom()
                .completionStage(() -> {
                    return s3AsyncClient.putObject(buildPutRequest(formData), AsyncRequestBody.fromFile(formData.data));
                })
    ...
    public RestMulti<Buffer> downloadFile(String objectKey) {
        ...
        return RestMulti.fromUniResponse(Uni.createFrom()
                .completionStage(() -> s3AsyncClient.getObject(buildGetRequest(objectKey),
